...
```{r, rotate=90}
individual_char_prelim_tree <- rpart(General ~.-session_id -sex -age, data = merged_individual, method="class")
rpart.plot(individual_char_prelim_tree, type = 4, clip.right.labs = FALSE, extra=2,  under = TRUE,  cex = 0.55
)
```
