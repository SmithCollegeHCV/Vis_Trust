...
model <- randomForest(response ~.-image_new, data = strongly_familiar_data, mtry= 12, importance = TRUE)
reprtree:::plot.reprtree( ReprTree(model, strongly_familiar_data, metric='d2'))
```
