...
In the below chunk, we  visualize how higher and lower trust is distributed by visual literacy, sex, and education to see if these 3 variables are corrolated or if one is proxy for the other. we find that they are independent
