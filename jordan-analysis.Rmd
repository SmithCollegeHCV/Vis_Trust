...
```{r}
model <- randomForest(category ~.-image_new, data = category_data, mtry= 8, importance = TRUE)
reprtree:::plot.reprtree( ReprTree(model, strongly_familiar_data, metric='d2'), depth= 4)
```
